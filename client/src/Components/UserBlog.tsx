 ...
 const [content, setContent] = useState('');
  ...
  return (
    ...
    <div style={styles.blogItem}>
        ...
        <div style={{ width:'60%', boxSizing: 'border-box', marginTop: '-20px',}}>
  <h1 style={{fontSize:15}}>Comments:</h1>
  <textarea
    value={content}
    onChange={(e) => setContent(e.target.value)}
    placeholder="Write your comment here..."
    style={{ width: '100%', boxSizing: 'border-box' ,height: '50px',borderRadius:'5px',background:'#f0f0f0'}}
  />
   <button onClick={handleCommentSubmit} style={{backgroundColor:'#8242e3', width: '10%',
              padding: '5px',
              borderRadius: '5px', border: 'none',}}>POST</button>
</div>
