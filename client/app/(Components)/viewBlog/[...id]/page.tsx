  ...
  return (
    <div className=' '>
      ...
      <div className=' h-[100vh] p-5'>
        ...
        {/* @ts-ignore */}
        <div className='text-[2.4rem] text-black mb-6 font-bold pl-5'>{blog.title}</div>
      ...
      <div className=' flex flex-col gap-4 p-4'>
        ...
        <input className=' text-gray-700 outline-none p-3 border-[1px] rounded-lg border-gray-500' type="text" onChange={(e)=> setComment(e.target.value)}  />
      ...
      <div className=' flex flex-col-reverse'>
        {getUserComments.map((val)=>(
          ...
          <div className='flex flex-col  justify-center p-2'>
            ...
            {/* @ts-ignore */}
            <div className=' text-[1.2rem] mb-8 text-gray-950 '>{val.comments}</div>
            </div>
          </div>
        ))}
      </div>
